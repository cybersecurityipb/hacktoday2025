...
## Flag
`hacktoday{bayangin_lu_bukan_seorang_web_main_tapi_karena_para_player_web_ganiat_lu_terpaksa_buat_soal-(woi p @ardhani, tolong yang solp tag beliau sambil bilang parah di dc hektod)}`